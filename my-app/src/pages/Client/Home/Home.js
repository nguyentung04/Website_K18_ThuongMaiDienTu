...
import "./Home.css";
import SliderBrand from "./component/logoSlider/logoSlider";
import CustomSlider from "./component/caocapSlider/high_end_product";
import PromotionalProducts from "./component/promotional_products/Promotional_products";
...
import BestSellingProducts from "./component/best_selling_products/best_selling_products";
import NewsGrid from "./component/News/news";
...
const Home = ({ loading }) => {
  ...
  return (
    <div className="home">
      ...
      <div class="container">
        <div
          class="block_strengths strengths-_strengths strengths_0 block"
          id="block_id_182"
        >
            ...
            <div class="item">
              <div class="svg">
                ...
                >
                  ...
                  ></path>{" "}
                  <path
                    d="M11 23.484L11.851 28.1784C11.8928 28.4089 12.0142 28.6174 12.1941 28.7676C12.3739 28.9178 12.6007 29 12.835 29H19.165C19.3993 29 19.6261 28.9178 19.8059 28.7676C19.9858 28.6174 20.1072 28.4089 20.149 28.1784L21 23.484"
                    stroke="white"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
      ...
      <div className="home-caocap">
        <CustomSlider />
      </div>
      <div className="home-noibat">
        <FeaturedProducts />
      </div>
      <div className="home-banchay">
        <PromotionalProducts />
      </div>
      <div className="home-introduce">
        <section className="introduce">
          <div className="home-introduce-row">
            <div className=" strwatchst1">
              <div className="introduce-image">
                <img
                  src="https://cdn.tgdd.vn/Files/2019/07/13/1179294/chinh-dong-ho-co-orient.jpg"
                  alt=""
                />
              </div>
              <div className="introduce-information">
                <h5>Đồng hồ Store</h5>
                <p>
                  Từ năm 2020, Đồng hồ Store đã trở thành người bạn đồng hành
                  tin cậy của những tín đồ yêu đồng hồ. Với đa dạng các mẫu mã
                  đến từ những thương hiệu nổi tiếng Nhật Bản và Thụy Sỹ, chúng
                  tôi cam kết mang đến cho bạn những trải nghiệm mua sắm tuyệt
                  vời nhất. Đừng ngần ngại ghé thăm Đồng hồ Store để được tư vấn
                  và lựa chọn chiếc đồng hồ ưng ý nhé!
                </p>
              </div>
            </div>
          </div>
